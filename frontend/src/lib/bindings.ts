 ...
 * Uses the Wails runtime Call.ByName API with the FQN format:
 *   "github.com/nicjacek/xlchemy.AppService.MethodName"
 *
 * These will be replaced by auto-generated bindings once `wails generate bindings` runs.
 */
