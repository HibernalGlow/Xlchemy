<script lang="ts">
  ...
  const solidMap: Record<ComponentColor, string> = {
    neutral: 'bg-ntrl-40 text-ntrl-100 hover:bg-[color-mix(in_oklch,var(--ntrl-40)_85%,white)] active:bg-[color-mix(in_oklch,var(--ntrl-40)_75%,white)]',
  ...
  const outlineMap: Record<ComponentColor, string> = {
    neutral: 'border-border-2 text-text-2 bg-transparent hover:bg-ntrl-30 active:bg-ntrl-35',
  ...
  const ghostMap: Record<ComponentColor, string> = {
    neutral: 'border-transparent text-text-2 bg-transparent hover:bg-ntrl-30 active:bg-ntrl-35',
