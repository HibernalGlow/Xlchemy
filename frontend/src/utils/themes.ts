...
export const presetThemes: ThemeConfig[] = [
  {
    name: 'Graphite',
    description: 'Refined graphite theme with preserved Miku cyan primary',
    isDark: true,
    colors: {
      light: {
        primary: 'oklch(0.66 0.13 182.83)',
        'primary-foreground': 'oklch(0.985 0.004 95)',
        accent: 'oklch(0.70 0.11 18)',
        'accent-foreground': 'oklch(0.985 0.004 95)',
        background: 'oklch(0.965 0.004 95)',
        foreground: 'oklch(0.26 0.014 250)',
        card: 'oklch(0.985 0.002 95)',
        'card-foreground': 'oklch(0.26 0.014 250)',
        popover: 'oklch(0.985 0.002 95)',
        'popover-foreground': 'oklch(0.26 0.014 250)',
        secondary: 'oklch(0.94 0.006 230)',
        'secondary-foreground': 'oklch(0.26 0.014 250)',
        muted: 'oklch(0.94 0.005 230)',
        'muted-foreground': 'oklch(0.54 0.012 250)',
        destructive: 'oklch(0.62 0.22 27)',
        border: 'oklch(0.88 0.006 230)',
        input: 'oklch(0.88 0.006 230)',
        ring: 'oklch(0.66 0.13 182.83)',
        'progress-text': 'oklch(0.40 0.03 250)',
        'sidebar-background': 'oklch(0.95 0.005 230)',
        'sidebar-foreground': 'oklch(0.26 0.014 250)',
        'sidebar-primary': 'oklch(0.66 0.13 182.83)',
        'sidebar-primary-foreground': 'oklch(0.985 0.004 95)',
        'sidebar-accent': 'oklch(0.93 0.006 230)',
        'sidebar-accent-foreground': 'oklch(0.26 0.014 250)',
        'sidebar-border': 'oklch(0.88 0.006 230)',
        'sidebar-ring': 'oklch(0.66 0.13 182.83)',
      },
      dark: {
        primary: 'oklch(0.7684 0.1370 182.83)',
        'primary-foreground': 'oklch(0.17 0.01 245)',
        accent: 'oklch(0.72 0.10 18)',
        'accent-foreground': 'oklch(0.18 0.01 245)',
        ...
        'secondary-foreground': 'oklch(0.93 0.005 95)',
        muted: 'oklch(0.26 0.012 250)',
        'muted-foreground': 'oklch(0.64 0.012 250)',
        destructive: 'oklch(0.70 0.18 25)',
        border: 'oklch(0.31 0.012 250)',
        input: 'oklch(0.31 0.012 250)',
        ring: 'oklch(0.7684 0.1370 182.83)',
        'progress-text': 'oklch(0.86 0.02 250)',
        'sidebar-background': 'oklch(0.155 0.008 250)',
        'sidebar-foreground': 'oklch(0.93 0.005 95)',
        'sidebar-primary': 'oklch(0.7684 0.1370 182.83)',
        'sidebar-primary-foreground': 'oklch(0.17 0.01 245)',
        'sidebar-accent': 'oklch(0.24 0.012 250)',
        'sidebar-accent-foreground': 'oklch(0.93 0.005 95)',
        'sidebar-border': 'oklch(0.28 0.012 250)',
