...
class SettingsTab(QWidget):
    ...
    def setupWidgets(self):
        ...
        self.processing_order_cmb = self.wm.addWidget("processing_order_cmb", ComboBox(("Original", "Random", "Sequential", "Path Ascending", "Path Descending", "Size Ascending", "Size Descending")))
